...
# from:
# https://arxiv.org/abs/1705.02364，《Supervised Learning of Universal Sentence Representations from Natural Language Inference Data》
...
q1_encoded = global_max_pooling(q1_encoded)
q2_encoded = global_max_pooling(q2_encoded)

q_abs = Lambda(lambda x: K.abs(x[0] - x[1]))([q1_encoded, q2_encoded])
q_mul = multiply([q1_encoded, q2_encoded])
...
dense = Dense(dense_dim, activation='relu')(merged)
...
model_weight_file = './model_infersent.h5'
model_file = './model_infersent.model'
